...
| 260601-pe4 | #1 capa de precio: /odds (1X2/OU/BTTS/AH de-vig Pinnacle) + manual córners/tarjetas + puente en el brief | 2026-06-01 | adbe29d | Complete | [260601-pe4-price-layer](./quick/260601-pe4-price-layer/) |
| 260601-pp2 | #2 player-props desde API-Football (/fixtures/players+events, selección actual) — reemplaza StatsBomb-torneo; load_props lo prefiere | 2026-06-01 | db51545 | Complete | [260601-pp2-player-props-af](./quick/260601-pp2-player-props-af/) |
| 260601-sx3 | #3 síntesis ponderada en el brief — tag de mecanismo + descuento de correlación (cuenta mec. indep., marca conflictos host-environment) | 2026-06-01 | 9fdffe0 | Complete | [260601-sx3-mechanism-synthesis](./quick/260601-sx3-mechanism-synthesis/) |
| 260601-en4 | #4 entorno-local (neto) — reconcilia host-fade vs altitud/descanso en un read con signo + eje de mercado | 2026-06-01 | 2ed2c7d | Complete | [260601-en4-env-local-net](./quick/260601-en4-env-local-net/) |
| 260601-rg5 | #5 régimen amistoso/competitivo en §6.6 — split Nc/Na + GF/GA solo-comp + aviso (hosts amistoso-pesados) | 2026-06-01 | 65ffff1 | Complete | [260601-rg5-regime-split](./quick/260601-rg5-regime-split/) |
| 260601-ag6 | #6 cross-check ABP↔GA en aerial_flag — marca conflicto si zaga 🔴/gk pero GA baja | 2026-06-01 | 65ffff1 | Complete | [260601-ag6-abp-ga-coherence](./quick/260601-ag6-abp-ga-coherence/) |
| 260601-pr8 | #8 degradar patrones WC-32 a prior (dirección>magnitud) — quita -12/-18pp, +5%, ×1.40 | 2026-06-01 | 56fd037 | Complete | [260601-pr8-degrade-priors](./quick/260601-pr8-degrade-priors/) |
| 260601-un9 | #9 unificar — guard de confederación + rol canónico de los dos ensambladores (no se fusionan, por analyst-approach) | 2026-06-01 | ecd3872 | Complete | [260601-un9-unify](./quick/260601-un9-unify/) |
...
| 260515-q38 | Bootstrap lambda-store extractor (snapshot->history via fixed parser). Empirical finding: 153 finished fixtures but 266 teams, median 1 appearance/team — Dixon-Coles fit correctly ABORTED by its own low-count guard. Wiring validated (schema contract + graceful no-store fallback); real per-league seasonal corpus is now PROVEN mandatory, not optional. | 2026-05-15 | b970802 | Verified (612 engine_v3 + 78 anti-Napoli green on main; real-data run exposes corpus insufficiency by design) | [260515-q38-bootstrap-lambda-store-extraer-176-fixtu](./quick/260515-q38-bootstrap-lambda-store-extraer-176-fixtu/) |
| 260531-smh | Complementar capa estadística §6.6 (PLAYING_STYLES_REFERENCE) con disciplina+SOT para las 48 selecciones WC2026: script 41 captura tarjetas+SOT-contra; tabla 8→10 cols (SOT F/C, TA/p, Faltas llena, +4 grandes); bloque de lectura mercado tarjetas. Hallazgo: rojas no fiables (excluidas), amarillas solo competitivas. Insight: faltas≠tarjetas (CAF físicas no son cards-over; Turquía/Uruguay sí por TA alto). | 2026-06-01 | d07d7eb | Verified (tabla 56 filas/10 cols consistente; extremos verificados vs cache) | [260531-smh-complementar-capa-estadistica-6-6-discip](./quick/260531-smh-complementar-capa-estadistica-6-6-discip/) |
